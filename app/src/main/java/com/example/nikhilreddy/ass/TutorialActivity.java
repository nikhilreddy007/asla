...
public class TutorialActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final CardView chap1Card = (CardView) findViewById(R.id.chap1Card);
        final CardView chap2Card = (CardView) findViewById(R.id.chap2Card);
        final CardView chap3Card = (CardView) findViewById(R.id.chap3Card);
        final CardView chap4Card = (CardView) findViewById(R.id.chap4Card);
        final CardView chap5Card = (CardView) findViewById(R.id.chap5Card);

        final Intent chap1_intent = new Intent(this, Chap1Activity.class);
        final Intent chap2_intent = new Intent(this, Chap2Activity.class);
        final Intent chap3_intent = new Intent(this, Chap3Activity.class);
        final Intent chap4_intent = new Intent(this, Chap4Activity.class);
        final Intent chap5_intent = new Intent(this, Chap5Activity.class);

        chap1Card.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                startActivity(chap1_intent);
            }
        });
        chap2Card.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                startActivity(chap2_intent);
            }
        });
        chap3Card.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                startActivity(chap3_intent);
            }
        });
        chap4Card.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                startActivity(chap4_intent);
            }
        });
...
//                final Intent disp_content = new Intent(TutorialActivity.this, displayContent.class);
